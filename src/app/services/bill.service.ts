...
let apiURL = "http://localhost/fm-services-api/public/index.php/api/bills";
...
export class BillService {
  ...
  // Create request
    postBill(billValues){
      ...
      return this.http.post(apiURL, JSON.stringify(billValues), postOptions)
    ...
    getSingleBill(billId){
      return this.http.get(apiURL+'/user/'+billId)
      .pipe(map((res) => res.json()));
    }
